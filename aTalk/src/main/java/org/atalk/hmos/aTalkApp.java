...
import static org.atalk.hmos.gui.settings.SettingsFragment.P_KEY_LOCALE;
...
public class aTalkApp extends Application implements LifecycleEventObserver {
     ...
     */
    public static final String SHOW_ICON_PROPERTY_NAME = "org.atalk.hmos.show_icon";

    /**
     * The EXIT action name that is broadcast to all OSGiActivities
     */
    public static final String ACTION_EXIT = "org.atalk.hmos.exit";
    ...
    public static void showSendLogsDialog() {
        ...
        String defaultEmail = getConfig().getString("org.atalk.hmos.LOG_REPORT_EMAIL");
