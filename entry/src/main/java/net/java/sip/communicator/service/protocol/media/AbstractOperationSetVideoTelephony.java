...
public abstract class AbstractOperationSetVideoTelephony<
    ...
    @SuppressWarnings("unchecked")
    // work with MediaAware* in media package
    public JComponent getLocalVisualComponent(CallPeer peer)
     ...
     */
    @Deprecated
    public JComponent getVisualComponent(CallPeer peer) {
        List<JComponent> visualComponents = getVisualComponents(peer);
    ...
    @SuppressWarnings("unchecked")
    // work with MediaAware* in media package
    public List<JComponent> getVisualComponents(CallPeer peer) {
