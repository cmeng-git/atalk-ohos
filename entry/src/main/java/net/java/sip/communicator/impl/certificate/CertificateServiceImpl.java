    ...
    public SSLContext getSSLContext(X509TrustManager trustManager)
        ...
        try {
            ...
            if (System.getProperty("javax.net.ssl.keyStore") != null) {
                ks.load(Files.newInputStream(Paths.get(System.getProperty("javax.net.ssl.keyStore"))), null);
            }
            else {
                ks.load(null, null);
            }
            ...
            do {
                ...
                for (AccessDescription ad : aia.getAccessDescriptions()) {
                    ...
                    if (cache != null && cache.cacheDate.after(new Date())) {
                        ...
                        Timber.d("Downloading parent certificate for <%s> from <%s>", current.getSubjectDN(), uri);
                        try (ResponseBody respBody = OkHttpUtils.open(HttpUrl.get(uri), false)) {
                            if (respBody != null) {
