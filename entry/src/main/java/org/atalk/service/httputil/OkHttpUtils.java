...
public class OkHttpUtils {
    ...
    public static String getUserAgent() {
        return String.format("%s/%s", BuildConfig.BUNDLE_NAME, BuildConfig.VERSION_NAME);
    }
     ...
     * @param zsonObject the Json parameters to include in post if not null or empty.
     ...
     */
    public static ResponseBody postForm(String url, ZSONObject zsonObject, String username, String password,
        ...
        if (zsonObject != null && !zsonObject.isEmpty()) {
            String content = zsonObject.toString();
