...
public class AppResourceServiceImpl extends AbstractResourcesService {
    ...
    /**
     * The {@link ResourceManager} object for application context
     */
    ...
    /**
     * The {@link ResourceManager} cache for language other than default
     */
    private ResourceManager cachedLocaleResources = null;
    ...
    AppResourceServiceImpl() {
        ...
        resourceManager = osgiService.getResourceManager();
        packageName = osgiService.getBundleName();
    ...
    private int getResourceId(String typeName, String key) {
        int id = resourceManager.getIdentifier(key, typeName, packageName);
        if (id == 0)
    ...
    public InputStream getImageInputStream(String key) {
        ...
        if (id != 0) {
            return resourceManager.openRawResource(id);
        }
        return null;
    }
    ...
    protected String doGetI18String(String key, Locale locale) {
        ResourceManager usedRes = resourceManager;
