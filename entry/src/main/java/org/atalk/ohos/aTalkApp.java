...
import static org.atalk.ohos.gui.settings.SettingsFragment.P_KEY_LOCALE;
...
import org.atalk.ohos.gui.account.AccountLoginActivity;
...
public class aTalkApp extends Application implements LifecycleEventObserver {
    ...
    public void onCreate() {
        ...
        // MigrationTo2.addOmemoDeviceLabel(DatabaseBackend.getInstance(this).getWritableDatabase());
