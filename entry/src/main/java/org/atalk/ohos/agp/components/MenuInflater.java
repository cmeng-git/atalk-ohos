...
public class MenuInflater {
    ...
    private final MenuInflater mInstance = null;
     ...
     */
    public void parse(int menuRes, Menu menu) {
        XmlResourceParser parser = null;
        try {
            parser = mContext.getResources().getLayout(menuRes);
            AttrSet attr = Xml.asAttributeSet(parser);

            parseMenu(parser, attrs, menu);
        } catch (XmlPullParserException | IOException e) {
            throw new InflateException("Error inflating menu XML: " + e.getMessage());
        } finally {
    ...
    private void registerMenu(@SuppressWarnings("unused") MenuItem item,
            @SuppressWarnings("unused") AttrSet set) {
    }
    ...
    private static class InflatedOnMenuItemClickListener implements MenuItem.ClickedListener {
