 ...
 */
public class QueryContactListProvider extends BaseContactListProvider
     ...
     */
    private final MetaContactListProvider metaContactList;
    ...
    /**
     * Creates new instance of <code>QueryContactListProvider</code>.
     *
     * @param fragment parent fragment.
     * @param contactListModel meta contact list model used as a base data model
     */
    public QueryContactListProvider(ContactListSlice fragment, MetaContactListProvider contactListModel) {
        super(fragment, true);
