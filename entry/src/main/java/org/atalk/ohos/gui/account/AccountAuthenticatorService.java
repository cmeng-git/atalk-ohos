 ...
 */
public class AccountAuthenticatorService extends Ability {
    /**
     ...
     *
     * @param intent The Intent that was used to bind to this service, as given to Context.bindService. Note
    ...
    private static class AccountAuthenticatorImpl extends AbstractAccountAuthenticator {
         ...
         * @param requiredFeatures a String array of authenticator-specific features that the added account must
         * support, may be null
         ...
         *
         * @param response used to set the result for the request. If the Constants.INTENT_KEY is set in the
