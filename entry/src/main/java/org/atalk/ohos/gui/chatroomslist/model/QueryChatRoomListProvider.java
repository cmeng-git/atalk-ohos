 ...
 */
public class QueryChatRoomListProvider extends BaseChatRoomListProvider
     ...
     */
    public QueryChatRoomListProvider(ChatRoomListSlice fragment, ChatRoomListProvider chatRoomListModel) {
        super(fragment);
