...
/**
 * Represents an event fired by providers of visual <code>JComponent</code>s depicting video to notify
 * about changes in the availability of such <code>JComponent</code>s.
 *
...
public class VideoEvent extends EventObject {
     ...
     * <code>JComponent</code> depicting video being made available by the firing
     * provider.
     */
    ...
    /**
     * The type of a <code>VideoEvent</code> which notifies about a specific visual
     * <code>JComponent</code> depicting video no longer being made available by the
     * firing provider.
     */
     ...
     * size of a specific visual <code>JComponent</code> depicting video.
     */
    public static final int VIDEO_SIZE_CHANGE = 3;

    /**
     * The indicator which determines whether this event and, more specifically,
     * the visual <code>JComponent</code> it describes have been consumed and should
     * be considered owned, referenced (which is important because
     * <code>JComponent</code>s belong to a single <code>Container</code> at a time).
     */
    ...
    /**
     * The visual <code>JComponent</code> depicting video which had its availability
     ...
     * change in the availability of a specific visual <code>JComponent</code>
     * depicting video and being provided by a specific source.
     *
     * @param source the source of the new <code>VideoEvent</code> and the provider
     * of the visual <code>JComponent</code> depicting video
     * @param type the type of the availability change which has caused the new
     * <code>VideoEvent</code> to be fired
     * @param visualComponent the visual <code>JComponent</code> depicting video
     * which had its availability in the <code>source</code> provider changed
     * @param origin the origin of the video the new <code>VideoEvent</code> is to notify about
     */
    public VideoEvent(Object source, int type, JComponent visualComponent, int origin) {
        super(source);
        this.type = type;
     ...
     *
     * @param source the <code>Object</code> which is to be reported as the source of the new instance
     *
    ...
    /**
     * Consumes this event and, more specifically, marks the <code>JComponent</code>
     ...
     * because <code>JComponent</code>s belong to a single <code>Container</code> at a time).
     */
    public void consume() {
        consumed = true;
    }
    ...
    /**
     * Gets the visual <code>JComponent</code> depicting video which had its
     * availability changed and which this <code>VideoEvent</code> notifies about.
     *
     * @return the visual <code>JComponent</code> depicting video which had its
     * availability changed and which this <code>VideoEvent</code> notifies about
     */
     ...
     * <code>JComponent</code> it describes have been consumed and should be
     ...
     *
     * @param origin one of the <code>VideoEvent</code> origin constants such as
     ...
     *
     * @param type one of the <code>VideoEvent</code> type constants such as
